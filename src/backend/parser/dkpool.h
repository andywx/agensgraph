...
#ifndef SRC_BACKEND_PARSER_DKPOOL_H_
#define SRC_BACKEND_PARSER_DKPOOL_H_
/*
 *  Dkpool.h
 *
 *  $Id$
...
extern numeric_t t_numeric_allocate (void);		/* thread space dynamic allocation */


#endif /* SRC_BACKEND_PARSER_DKPOOL_H_ */
